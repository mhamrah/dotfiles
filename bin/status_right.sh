...
if [ "$WIDTH" -ge 160 ]; then
    echo -n "#[fg=colour236,bg=colour234,nobold,nounderscore,noitalics]#[fg=colour247,bg=colour236] $(date +%y.%m.%d)  $(date +%H:%M) #[fg=colour252,bg=colour236,nobold,nounderscore,noitalics]#[fg=colour235,bg=colour252] #h "
